...
class Solution {
    public int findMin(int[] nums) {
        ...
        // Imagine in the end two numbers left in the array. the pointers will be moved such that only one element will be left in the array.
        // That element will be the minimum element becasue we are moving the pointers to the minimum element.
        return nums[right];
    }
}
